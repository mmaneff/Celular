...
//        this.setContentView(root);
        ...
        lstOpciones.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> a, View v, int position,long id) {
                if(id > 0){
                    ...
                    Intent intent = new Intent(Busqueda.this, Datos.class);
    ...
    private void CargarLista2() {
        ...
        System.out.println("Entró en cargarLista2()");

        ItemNegocioAdapter adapter = new ItemNegocioAdapter(this, itemslista, Color.parseColor("#B2B6B7"));
        lstOpciones = (ListView)findViewById(R.id.listView1);
        
        if(adapter.getCount()!=0){
        	lstOpciones.setAdapter(adapter); 
      }else{
           Toast.makeText(Busqueda.this, "No se encontraron resultados para esa búsqueda",Toast.LENGTH_LONG).show();
      }
...
//			rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.fondoalimentos));
            ...
            ArrayList<Comercio> comercios = getComerciosPorBusqueda(busqueda);
    ...
    private void establecerColorDeFondo() {
        ...
        rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.fondomejorado));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaalimentosnegocios));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaautomotornegocios));
//        } else if( nombre.equals("PRESTAMOS")) {
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listabancosytarjetasnegocios));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listabellezanegocios));
...
//                nombre.equals("INDUMENTARIA NIÃ‘OS") || nombre.equals("JOYERIA") ||
//                nombre.equals("RELOJERIA/JOYERIA") ) {
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaboutiquenegocios));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaconstruccionnegocios));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listadecoracionyhogarnegocios));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaeducacionnegocios));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaemergencianegocios));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaeventosyfiestasnegocios));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listagastronomianegocios));
//        } else if( (nombre.equals("IMPRESIONES") ) ) {
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaimprentanegocios));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaprofesionalesnegocios));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listasaludnegocios));
//        } else if( (nombre.equals("ALARMAS") || (nombre.equals("SEGUROS")) ||
//                nombre.equals("SERVICIOS DE CAMARAS") ) ) {
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaseguridadnegocios));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaserviciospublicosnegocios));
...
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listashoppingygaleriasnegocios));
...
//                nombre.equals("YOGA") ) {
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listatiempoyrecreacionnegocios));
//        } else if( (nombre.equals("REMISERIA") ) ) {
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listatransportenegocios));
//        } else if( (nombre.equals("AGENCIA DE VIAJE") || (nombre.equals("BOLETOS OMNIBUS")) ) ) {
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaturismonegocios));
//        } else {
//            rl.setBackgroundDrawable(getResources().getDrawable(R.drawable.listaalimentosnegocios));
//        }
    }
...
//
//        ItemNegocioAdapter adapter = new ItemNegocioAdapter(this, itemslista);
//        lstOpciones = (ListView)findViewById(R.id.listView1);
//
//        lstOpciones.setAdapter(adapter);
//
...
//    }
    ...
    private ArrayList<Comercio> getComerciosPorBusqueda(String parametroBusqueda) {
