...
public class ItemListaAdapter2 extends BaseAdapter {
	 protected Activity activity;
	  protected ArrayList<ItemLista2> items;
	  
	  public ItemListaAdapter2(Activity activity, ArrayList<ItemLista2> items) {
	  ...
	  public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    ItemLista2 item = items.get(position);
	    ...
	    fondo.setBackgroundColor(Color.parseColor(item.getColorFondo()));    
